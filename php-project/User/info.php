...
<div class="container user_container" style="margin-bottom: 5%;">
    <div class="row align-items-stretch no-gutters contact-wrap">
        <div class="col-md-3 sidebar_div">
            ...
            <h6 style="color: white;"><i class="fas fa-user-alt user_icons" style="color: #293A80;"></i><?php echo $_SESSION['user_name']?></h6>
            <br><br>
        ...
        <div class="col-md-9" id="user_info_form">
            ...
            try {
                $id = $_SESSION['id'];
                $query1 = "SELECT user_name, user_email, user_mobile, user_location FROM users WHERE user_id = :ID";
