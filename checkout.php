...
<body>
    ...
    $select_statment->bindParam(":order_id", $_SESSION['id2']);
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" method="POST">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="firstName" name="name" placeholder="haneen" value="<?php echo  $data['order_user_name'] ?>">
                        <?php echo $errors[0] ?? "" ?>
                    </div>
                    <div class="mb-3">
                        <label for="address">Address</label>
                        <input type="text" class="form-control" id="address" name="address" placeholder="1234 Main St" value="<?php echo  $data['order_location'] ?>">
                        <?php echo $errors[2] ?? "" ?>
                    </div>
                    <div class="mb-3">
                        <label for="phone">Phone Number</label>
                        <input type="text" class="form-control" id="phonenum" name="phone" placeholder="07777777" value="<?php echo  $data['order_mobile'] ?>">
                    </div>
